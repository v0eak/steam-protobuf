...
export interface CParentalGetSignedParentalSettingsResponse {
  serializedSettings?: Uint8Array | undefined;
...
function createBaseCParentalGetSignedParentalSettingsResponse(): CParentalGetSignedParentalSettingsResponse {
  return { serializedSettings: new Uint8Array(0), signature: new Uint8Array(0) };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.serializedSettings = reader.bytes();
          continue;
        }
        case 2: {
          if (tag !== 18) {
...
function createBaseCParentalParentalSettingsChangeNotification(): CParentalParentalSettingsChangeNotification {
  return { serializedSettings: new Uint8Array(0), signature: new Uint8Array(0), password: "", sessionid: "" };
}
