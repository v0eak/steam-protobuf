...
import { EContentReportReason, EContentReportResolution, EContentReportSubjectType } from "./enums.js";
import { CMsgClientPersonaState_Friend } from "./steammessages_clientserver_friends.js";
...
export interface CChatRoomGroupHeaderState {
  ...
  avatarSha?: Uint8Array | undefined;
...
export interface CChatRoomGetChatRoomGroupSummaryResponse {
  ...
  accountidOwner?: number | undefined;
  topMembers: number[];
  chatGroupAvatarSha?: Uint8Array | undefined;
  rank?: EChatRoomGroupRank | undefined;
  defaultRoleId?: number | undefined;
  roleIds: number[];
  roleActions: CChatRoleActions[];
...
export interface CChatRoomResolveReportRequest {
  ...
  subjectType?: EContentReportSubjectType | undefined;
  chatGroupId?: number | undefined;
  kickExpirationTime?: number | undefined;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 16: {
          ...
          message.avatarSha = reader.bytes();
          continue;
        }
        case 17: {
          if (tag !== 136) {
...
function createBaseCChatRoomSetChatRoomGroupAvatarRequest(): CChatRoomSetChatRoomGroupAvatarRequest {
  return { chatGroupId: 0, avatarSha: new Uint8Array(0) };
}
...
function createBaseCChatRoomGetChatRoomGroupSummaryResponse(): CChatRoomGetChatRoomGroupSummaryResponse {
  return {
    ...
    accountidOwner: 0,
    topMembers: [],
    chatGroupAvatarSha: new Uint8Array(0),
    rank: 0,
    defaultRoleId: 0,
    roleIds: [],
    roleActions: [],
...
export const CChatRoomResolveReportRequest: MessageFns<CChatRoomResolveReportRequest> = {
  encode(message: CChatRoomResolveReportRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.chatGroupId !== undefined && message.chatGroupId !== 0) {
      writer.uint32(48).uint64(message.chatGroupId);
    }
    if (message.kickExpirationTime !== undefined && message.kickExpirationTime !== 0) {
      writer.uint32(56).uint32(message.kickExpirationTime);
    }
    if (message.skipLock !== undefined && message.skipLock !== false) {
      writer.uint32(64).bool(message.skipLock);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.kickExpirationTime = reader.uint32();
          continue;
        }
        case 8: {
          if (tag !== 64) {
