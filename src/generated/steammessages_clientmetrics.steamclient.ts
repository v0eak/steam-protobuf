...
import { CClientMetricsClientBootstrapSummary, CClientMetricsContentDownloadResponseHosts } from "./clientmetrics.js";
import { EGameRecordingType, EGRMode } from "./enums.js";
import { GamePerformanceSettings, UserSystemInformation } from "./steammessages_base.js";
...
export interface CClientMetricsDownloadRatesNotification_StatsInfo {
  ...
  chunksScored?: number | undefined;
  sumChunkScores?: number | undefined;
}
...
export interface CClientMetricsGamePerformanceNotification {
  frameRates: CClientMetricsGamePerformanceNotification_FrameRate[];
  systemInfo?: UserSystemInformation | undefined;
}

export interface CClientMetricsGamePerformanceNotification_FrameRate {
  gameid?: number | undefined;
  frameRate?: number | undefined;
  sessionSeconds?: number | undefined;
  framegenFrameRate?: number | undefined;
  gameSettings?: GamePerformanceSettings | undefined;
}
...
function createBaseCClientMetricsReportClientErrorNotification_Error(): CClientMetricsReportClientErrorNotification_Error {
  return { identifier: "", message: "", count: 0, context: "", url: "" };
}
...
> = {
  encode(
    ...
    if (message.chunksScored !== undefined && message.chunksScored !== 0) {
      writer.uint32(104).uint32(message.chunksScored);
    }
    if (message.sumChunkScores !== undefined && message.sumChunkScores !== 0) {
      writer.uint32(113).double(message.sumChunkScores);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.chunksScored = reader.uint32();
          continue;
        }
        case 14: {
          if (tag !== 113) {
          ...
          message.sumChunkScores = reader.double();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCClientMetricsGamePerformanceNotification(): CClientMetricsGamePerformanceNotification {
  return { frameRates: [], systemInfo: undefined };
}
...
export const CClientMetricsGamePerformanceNotification: MessageFns<CClientMetricsGamePerformanceNotification> = {
  encode(message: CClientMetricsGamePerformanceNotification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.frameRates) {
      CClientMetricsGamePerformanceNotification_FrameRate.encode(v!, writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 2: {
          ...
          message.frameRates.push(CClientMetricsGamePerformanceNotification_FrameRate.decode(reader, reader.uint32()));
          continue;
        }
        case 3: {
          if (tag !== 26) {
...
function createBaseCClientMetricsGamePerformanceNotification_FrameRate(): CClientMetricsGamePerformanceNotification_FrameRate {
  return { gameid: 0, frameRate: 0, sessionSeconds: 0, framegenFrameRate: 0, gameSettings: undefined };
}

export const CClientMetricsGamePerformanceNotification_FrameRate: MessageFns<
  CClientMetricsGamePerformanceNotification_FrameRate
> = {
  encode(
    message: CClientMetricsGamePerformanceNotification_FrameRate,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.gameid !== undefined && message.gameid !== 0) {
    ...
    if (message.sessionSeconds !== undefined && message.sessionSeconds !== 0) {
      writer.uint32(24).int32(message.sessionSeconds);
    }
    if (message.framegenFrameRate !== undefined && message.framegenFrameRate !== 0) {
      writer.uint32(32).uint32(message.framegenFrameRate);
    }
    if (message.gameSettings !== undefined) {
      GamePerformanceSettings.encode(message.gameSettings, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CClientMetricsGamePerformanceNotification_FrameRate {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCClientMetricsGamePerformanceNotification_FrameRate();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 4: {
          ...
          message.framegenFrameRate = reader.uint32();
          continue;
        }
        case 5: {
          if (tag !== 42) {
          ...
          message.gameSettings = GamePerformanceSettings.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
