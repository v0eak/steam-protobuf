...
export enum EDisplayManagerRGBRange {
...
export interface CMsgNetworkDevicesData_Device_Wireless_AP {
  ...
  hasNon6ghzChannel?: boolean | undefined;
...
export interface CMsgSystemDisplay {
  ...
  rgbRange?: EDisplayManagerRGBRange | undefined;
}
...
export interface CMsgClientShaderHitCacheEntry {
  keySha?: Uint8Array | undefined;
  codeSha?: Uint8Array | undefined;
...
export const CMsgNetworkDevicesData_Device_Wireless_AP: MessageFns<CMsgNetworkDevicesData_Device_Wireless_AP> = {
  encode(message: CMsgNetworkDevicesData_Device_Wireless_AP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hasNon6ghzChannel !== undefined && message.hasNon6ghzChannel !== false) {
      writer.uint32(88).bool(message.hasNon6ghzChannel);
    }
    if (message.isSaved !== undefined && message.isSaved !== false) {
      writer.uint32(96).bool(message.isSaved);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.hasNon6ghzChannel = reader.bool();
          continue;
        }
        case 12: {
          if (tag !== 96) {
...
export const CMsgNetworkDeviceConnect: MessageFns<CMsgNetworkDeviceConnect> = {
  encode(message: CMsgNetworkDeviceConnect, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.wireless !== undefined) {
      CMsgNetworkDeviceConnect_Wireless.encode(message.wireless, writer.uint32(58).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.wireless = CMsgNetworkDeviceConnect_Wireless.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
...
function createBaseCMsgNetworkDeviceConnect_Wireless(): CMsgNetworkDeviceConnect_Wireless {
  return { bandFilter: "" };
}

export const CMsgNetworkDeviceConnect_Wireless: MessageFns<CMsgNetworkDeviceConnect_Wireless> = {
  encode(message: CMsgNetworkDeviceConnect_Wireless, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bandFilter !== undefined && message.bandFilter !== "") {
      writer.uint32(10).string(message.bandFilter);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgNetworkDeviceConnect_Wireless {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCMsgNetworkDeviceConnect_Wireless();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
export const CMsgSystemDisplay: MessageFns<CMsgSystemDisplay> = {
  encode(message: CMsgSystemDisplay, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rgbRange !== undefined && message.rgbRange !== 0) {
      writer.uint32(152).int32(message.rgbRange);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 19: {
          ...
          message.rgbRange = reader.int32() as any;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCMsgSystemDisplayManagerSetMode(): CMsgSystemDisplayManagerSetMode {
  return { displayId: 0, modeId: 0, rgbRange: 0 };
}
...
export const CMsgSystemDisplayManagerSetMode: MessageFns<CMsgSystemDisplayManagerSetMode> = {
  encode(message: CMsgSystemDisplayManagerSetMode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rgbRange !== undefined && message.rgbRange !== 0) {
      writer.uint32(24).int32(message.rgbRange);
    }
    return writer;
  },
...
function createBaseCMsgMonitorInfo(): CMsgMonitorInfo {
  return { selectedDeviceName: "", monitors: [] };
}
...
export const CMsgMonitorInfo: MessageFns<CMsgMonitorInfo> = {
  encode(message: CMsgMonitorInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.selectedDeviceName !== "") {
      writer.uint32(10).string(message.selectedDeviceName);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.selectedDeviceName = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
...
function createBaseCMsgClientShaderHitCacheEntry(): CMsgClientShaderHitCacheEntry {
  return { keySha: new Uint8Array(0), codeSha: new Uint8Array(0), timeLastReported: 0 };
}
