...
export interface CMsgClientRichPresenceUpload {
  richPresenceKv?: Uint8Array | undefined;
...
export interface CMsgClientCheckFileSignatureResponse {
  ...
  shaFile?: Uint8Array | undefined;
  signatureheader?: Uint8Array | undefined;
...
export interface CMsgClientRegisterOEMMachine {
  oemRegisterFile?: Uint8Array | undefined;
}
...
export interface CMsgClientPurchaseWithMachineID {
  ...
  machineInfo?: Uint8Array | undefined;
}
...
export interface CMsgClientGetDepotDecryptionKeyResponse {
  eresult?: number | undefined;
  depotId?: number | undefined;
  depotEncryptionKey?: Uint8Array | undefined;
}
...
export interface CMsgDRMDownloadRequestWithCrashData {
  ...
  guidDrm?: Uint8Array | undefined;
  guidSplit?: Uint8Array | undefined;
  guidMerge?: Uint8Array | undefined;
  moduleName?: string | undefined;
  modulePath?: string | undefined;
  crashData?: Uint8Array | undefined;
}
...
export interface CMsgDRMDownloadResponse {
  ...
  mergeGuid?: Uint8Array | undefined;
...
export interface CMsgClientServiceCall {
  sysidRouting?: Uint8Array | undefined;
  callHandle?: number | undefined;
  moduleCrc?: number | undefined;
  moduleHash?: Uint8Array | undefined;
  functionId?: number | undefined;
  cubOutputMax?: number | undefined;
  flags?: number | undefined;
  callparameter?: Uint8Array | undefined;
...
export interface CMsgClientServiceModule {
  moduleCrc?: number | undefined;
  moduleHash?: Uint8Array | undefined;
  moduleContent?: Uint8Array | undefined;
}
...
export interface CMsgClientServiceCallResponse {
  ...
  resultContent?: Uint8Array | undefined;
  osVersionInfo?: Uint8Array | undefined;
  systemInfo?: Uint8Array | undefined;
  loadAddress?: number | undefined;
  exceptionRecord?: Uint8Array | undefined;
  portableOsVersionInfo?: Uint8Array | undefined;
  portableSystemInfo?: Uint8Array | undefined;
  ...
  lastCallSysidRouting?: Uint8Array | undefined;
...
function createBaseCMsgClientUpdateUserGameInfo(): CMsgClientUpdateUserGameInfo {
  return { steamidIdgs: 0, gameid: 0, gameIp: 0, gamePort: 0, token: new Uint8Array(0) };
}
...
function createBaseCMsgClientRichPresenceUpload(): CMsgClientRichPresenceUpload {
  return { richPresenceKv: new Uint8Array(0), steamidBroadcast: [] };
}
...
function createBaseCMsgClientCheckFileSignatureResponse(): CMsgClientCheckFileSignatureResponse {
  return {
    ...
    filename: "",
    esignatureresult: 0,
    shaFile: new Uint8Array(0),
    signatureheader: new Uint8Array(0),
    filesize: 0,
    getlasterror: 0,
...
function createBaseCMsgClientPurchaseResponse(): CMsgClientPurchaseResponse {
  return { eresult: 2, purchaseResultDetails: 0, purchaseReceiptInfo: new Uint8Array(0) };
}
...
function createBaseCMsgClientRegisterOEMMachine(): CMsgClientRegisterOEMMachine {
  return { oemRegisterFile: new Uint8Array(0) };
}
...
function createBaseCMsgClientPurchaseWithMachineID(): CMsgClientPurchaseWithMachineID {
  return { packageId: 0, machineInfo: new Uint8Array(0) };
}
...
function createBaseCMsgClientGetDepotDecryptionKeyResponse(): CMsgClientGetDepotDecryptionKeyResponse {
  return { eresult: 2, depotId: 0, depotEncryptionKey: new Uint8Array(0) };
}
...
function createBaseCMsgClientOGSReportString(): CMsgClientOGSReportString {
  return { accumulated: false, sessionid: 0, severity: 0, formatter: "", varargs: new Uint8Array(0) };
}
...
function createBaseCMsgClientOGSReportBug(): CMsgClientOGSReportBug {
  return { sessionid: 0, bugtext: "", screenshot: new Uint8Array(0) };
}
...
function createBaseCMsgGCClient(): CMsgGCClient {
  return { appid: 0, msgtype: 0, payload: new Uint8Array(0), steamid: 0, gcname: "", ip: 0, flags: 0 };
}
...
function createBaseCMsgDRMDownloadRequestWithCrashData(): CMsgDRMDownloadRequestWithCrashData {
  return {
    ...
    guidDrm: new Uint8Array(0),
    guidSplit: new Uint8Array(0),
    guidMerge: new Uint8Array(0),
    moduleName: "",
    modulePath: "",
    crashData: new Uint8Array(0),
  };
}
...
function createBaseCMsgClientDPCheckSpecialSurveyResponse(): CMsgClientDPCheckSpecialSurveyResponse {
  return { eResult: 2, state: 0, name: "", customUrl: "", includeSoftware: false, token: new Uint8Array(0) };
}
...
function createBaseCMsgClientDPSendSpecialSurveyResponse(): CMsgClientDPSendSpecialSurveyResponse {
  return { surveyId: 0, data: new Uint8Array(0) };
}
...
function createBaseCMsgClientDPSendSpecialSurveyResponseReply(): CMsgClientDPSendSpecialSurveyResponseReply {
  return { eResult: 2, token: new Uint8Array(0) };
}
...
function createBaseCMsgClientServiceMethodLegacy(): CMsgClientServiceMethodLegacy {
  return { methodName: "", serializedMethod: new Uint8Array(0), isNotification: false };
}
...
function createBaseCMsgClientServiceMethodLegacyResponse(): CMsgClientServiceMethodLegacyResponse {
  return { methodName: "", serializedMethodResponse: new Uint8Array(0) };
}
...
function createBaseCMsgClientServiceCall(): CMsgClientServiceCall {
  return {
    sysidRouting: new Uint8Array(0),
    callHandle: 0,
    moduleCrc: 0,
    moduleHash: new Uint8Array(0),
    functionId: 0,
    cubOutputMax: 0,
    flags: 0,
    callparameter: new Uint8Array(0),
    pingOnly: false,
...
function createBaseCMsgClientServiceModule(): CMsgClientServiceModule {
  return { moduleCrc: 0, moduleHash: new Uint8Array(0), moduleContent: new Uint8Array(0) };
}
...
function createBaseCMsgClientServiceCallResponse(): CMsgClientServiceCallResponse {
  return {
    ...
    moduleHash: new Uint8Array(0),
    ecallresult: 0,
    resultContent: new Uint8Array(0),
    osVersionInfo: new Uint8Array(0),
    systemInfo: new Uint8Array(0),
    loadAddress: 0,
    exceptionRecord: new Uint8Array(0),
    portableOsVersionInfo: new Uint8Array(0),
    portableSystemInfo: new Uint8Array(0),
    wasConverted: false,
    internalResult: 0,
    currentCount: 0,
    lastCallHandle: 0,
    lastCallModuleCrc: 0,
    lastCallSysidRouting: new Uint8Array(0),
    lastEcallresult: 0,
...
function createBaseCMsgAMUnlockH264Response(): CMsgAMUnlockH264Response {
  return { eresult: 2, encryptionKey: new Uint8Array(0) };
}
