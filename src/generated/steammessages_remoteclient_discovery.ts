...
export interface CMsgRemoteClientBroadcastHeader {
  ...
  deviceToken?: Uint8Array | undefined;
}
...
export interface CMsgRemoteClientBroadcastStatus {
  ...
  isLowSpecHardware?: boolean | undefined;
...
export interface CMsgRemoteClientBroadcastClientPairingState {
  myPairedNetworkHash?: number | undefined;
  myPairingTime?: number | undefined;
}

export interface CMsgRemoteClientBroadcastClientPairingExclusivity {
  ifPairedNetworkHashIs?: number | undefined;
  unpairUnlessYouAreClientId?: number | undefined;
  lastKnownPairingTime?: number | undefined;
}
...
export interface CMsgRemoteDeviceStreamingResponse {
  ...
  encryptedSessionKey?: Uint8Array | undefined;
...
function createBaseCMsgRemoteClientBroadcastHeader(): CMsgRemoteClientBroadcastHeader {
  return { clientId: 0, msgType: 0, instanceId: 0, deviceIdOBSOLETE: 0, deviceToken: new Uint8Array(0) };
}
...
export const CMsgRemoteClientBroadcastStatus: MessageFns<CMsgRemoteClientBroadcastStatus> = {
  encode(message: CMsgRemoteClientBroadcastStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.isLowSpecHardware !== undefined && message.isLowSpecHardware !== false) {
      writer.uint32(240).bool(message.isLowSpecHardware);
    }
    if (message.gamingDeviceType !== undefined && message.gamingDeviceType !== 0) {
      writer.uint32(248).uint32(message.gamingDeviceType);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 30: {
          ...
          message.isLowSpecHardware = reader.bool();
          continue;
        }
        case 31: {
          if (tag !== 248) {
...
function createBaseCMsgRemoteDeviceAuthorizationRequest(): CMsgRemoteDeviceAuthorizationRequest {
  return {
    deviceToken: new Uint8Array(0),
    deviceName: "",
    encryptedRequest: new Uint8Array(0),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.encryptedRequest = reader.bytes();
          continue;
        }
        case 4: {
          if (tag !== 34) {
...
function createBaseCMsgRemoteDeviceAuthorizationResponse(): CMsgRemoteDeviceAuthorizationResponse {
  return { result: 0, steamid: 0, authKey: new Uint8Array(0), deviceToken: new Uint8Array(0) };
}
...
function createBaseCMsgRemoteClientBroadcastClientPairingState(): CMsgRemoteClientBroadcastClientPairingState {
  return { myPairedNetworkHash: 0, myPairingTime: 0 };
}

export const CMsgRemoteClientBroadcastClientPairingState: MessageFns<CMsgRemoteClientBroadcastClientPairingState> = {
  encode(
    message: CMsgRemoteClientBroadcastClientPairingState,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.myPairedNetworkHash !== undefined && message.myPairedNetworkHash !== 0) {
      writer.uint32(9).fixed64(message.myPairedNetworkHash);
    }
    if (message.myPairingTime !== undefined && message.myPairingTime !== 0) {
      writer.uint32(16).uint32(message.myPairingTime);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgRemoteClientBroadcastClientPairingState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCMsgRemoteClientBroadcastClientPairingState();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.myPairedNetworkHash = longToNumber(reader.fixed64());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.myPairingTime = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCMsgRemoteClientBroadcastClientPairingExclusivity(): CMsgRemoteClientBroadcastClientPairingExclusivity {
  return { ifPairedNetworkHashIs: 0, unpairUnlessYouAreClientId: 0, lastKnownPairingTime: 0 };
}

export const CMsgRemoteClientBroadcastClientPairingExclusivity: MessageFns<
...
> = {
  encode(
    ...
    if (message.ifPairedNetworkHashIs !== undefined && message.ifPairedNetworkHashIs !== 0) {
      writer.uint32(9).fixed64(message.ifPairedNetworkHashIs);
    }
    if (message.unpairUnlessYouAreClientId !== undefined && message.unpairUnlessYouAreClientId !== 0) {
      writer.uint32(17).fixed64(message.unpairUnlessYouAreClientId);
    }
    if (message.lastKnownPairingTime !== undefined && message.lastKnownPairingTime !== 0) {
      writer.uint32(24).uint32(message.lastKnownPairingTime);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgRemoteClientBroadcastClientPairingExclusivity {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCMsgRemoteClientBroadcastClientPairingExclusivity();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.ifPairedNetworkHashIs = longToNumber(reader.fixed64());
          continue;
        }
        case 2: {
          if (tag !== 17) {
          ...
          message.unpairUnlessYouAreClientId = longToNumber(reader.fixed64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.lastKnownPairingTime = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const CMsgRemoteDeviceStreamingRequest: MessageFns<CMsgRemoteDeviceStreamingRequest> = {
  encode(message: CMsgRemoteDeviceStreamingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.maximumFramerateNumerator !== undefined && message.maximumFramerateNumerator !== 0) {
      writer.uint32(168).int32(message.maximumFramerateNumerator);
    }
    if (message.maximumFramerateDenominator !== undefined && message.maximumFramerateDenominator !== 0) {
      writer.uint32(176).int32(message.maximumFramerateDenominator);
    }
    if (message.displayHdr !== undefined && message.displayHdr !== false) {
      writer.uint32(184).bool(message.displayHdr);
    }
    return writer;
  },
...
function createBaseCMsgRemoteDeviceStreamingResponse(): CMsgRemoteDeviceStreamingResponse {
  return {
    ...
    result: 0,
    port: 0,
    encryptedSessionKey: new Uint8Array(0),
    transport: 1,
    relayServer: "",
    cert: "",
  };
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.encryptedSessionKey = reader.bytes();
          continue;
        }
        case 6: {
          if (tag !== 48) {
...
function createBaseCMsgRemoteDeviceProofRequest(): CMsgRemoteDeviceProofRequest {
  return { challenge: new Uint8Array(0), requestId: 0, updateSecret: false };
}
...
function createBaseCMsgRemoteDeviceProofResponse(): CMsgRemoteDeviceProofResponse {
  return { response: new Uint8Array(0), requestId: 0, updatedSecret: false };
}
...
function createBaseCMsgRemoteDeviceStreamTransportSignal(): CMsgRemoteDeviceStreamTransportSignal {
  return { token: new Uint8Array(0), payload: new Uint8Array(0) };
}
