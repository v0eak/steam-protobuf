...
import { ECloudStoragePersistState, EPublishedFileStorageSystem } from "./enums.js";
import { CCloudPendingRemoteOperation } from "./steammessages_client_objects.js";
...
export interface ClientCloudFileUploadBlockDetails {
  ...
  explicitBodyData?: Uint8Array | undefined;
...
export interface CCloudAppFileInfo {
  ...
  reuploadRequested?: boolean | undefined;
}
...
function createBaseCCloudGetSingleFileInfoResponse(): CCloudGetSingleFileInfoResponse {
  return { appId: 0, fileName: "", shaFile: new Uint8Array(0), timeStamp: 0, rawFileSize: 0, isExplicitDelete: false };
}
...
function createBaseCCloudGetClientEncryptionKeyResponse(): CCloudGetClientEncryptionKeyResponse {
  return { key: new Uint8Array(0), crc: 0 };
}
...
function createBaseClientCloudFileUploadBlockDetails(): ClientCloudFileUploadBlockDetails {
  return {
    ...
    blockOffset: 0,
    blockLength: 0,
    explicitBodyData: new Uint8Array(0),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.explicitBodyData = reader.bytes();
          continue;
        }
        case 9: {
          if (tag !== 72) {
...
function createBaseCCloudClientCommitFileUploadRequest(): CCloudClientCommitFileUploadRequest {
  return { transferSucceeded: false, appid: 0, fileSha: new Uint8Array(0), filename: "" };
}
...
export const CCloudAppFileInfo: MessageFns<CCloudAppFileInfo> = {
  encode(message: CCloudAppFileInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.reuploadRequested !== undefined && message.reuploadRequested !== false) {
      writer.uint32(72).bool(message.reuploadRequested);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.reuploadRequested = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
