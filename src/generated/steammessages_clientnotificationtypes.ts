...
function createBaseCClientNotificationControllerLowBattery(): CClientNotificationControllerLowBattery {
  return { controllerType: 0, pctRemaining: 0 };
}

export const CClientNotificationControllerLowBattery: MessageFns<CClientNotificationControllerLowBattery> = {
  encode(message: CClientNotificationControllerLowBattery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.controllerType !== undefined && message.controllerType !== 0) {
      writer.uint32(8).uint32(message.controllerType);
    }
    if (message.pctRemaining !== undefined && message.pctRemaining !== 0) {
      writer.uint32(21).float(message.pctRemaining);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CClientNotificationControllerLowBattery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCClientNotificationControllerLowBattery();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
function createBaseCClientNotificationControllerConnected(): CClientNotificationControllerConnected {
  return { controllerIndex: 0 };
}

export const CClientNotificationControllerConnected: MessageFns<CClientNotificationControllerConnected> = {
  encode(message: CClientNotificationControllerConnected, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.controllerIndex !== undefined && message.controllerIndex !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CClientNotificationControllerConnected {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCClientNotificationControllerConnected();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
function createBaseCClientNotificationControllerDisconnected(): CClientNotificationControllerDisconnected {
  return { controllerType: 0, controllerName: "" };
}

export const CClientNotificationControllerDisconnected: MessageFns<CClientNotificationControllerDisconnected> = {
  encode(message: CClientNotificationControllerDisconnected, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.controllerType !== undefined && message.controllerType !== 0) {
      writer.uint32(8).uint32(message.controllerType);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CClientNotificationControllerDisconnected {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCClientNotificationControllerDisconnected();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
