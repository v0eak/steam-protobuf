...
export interface CMsgAuthTicket {
  ...
  serverSecret?: Uint8Array | undefined;
...
export interface CPackageReservationStatus {
  ...
  positionIsWaitlist?: boolean | undefined;
  userWaitlistToken?: string | undefined;
  queueInWaitlist?: boolean | undefined;
  queueWaitlistToken?: string | undefined;
  reservationType?: boolean | undefined;
}
...
export interface UserSystemInformation {
  ...
  os?: string | undefined;
  cpuVendor?: string | undefined;
  cpuName?: string | undefined;
  gamingDeviceType?: number | undefined;
  dxDriverVersion?: string | undefined;
  adapterDescription?: string | undefined;
  driverVersion?: string | undefined;
  driverDate?: string | undefined;
  vramSize?: number | undefined;
  screenWidth?: number | undefined;
  screenHeight?: number | undefined;
  preciseFrameRate?: boolean | undefined;
}

export interface GamePerformanceSettings {
  setting?: GamePerformanceSettings_EGamePerformanceSetting | undefined;
  gameResolutionWidth?: number | undefined;
  gameResolutionHeight?: number | undefined;
}

export enum GamePerformanceSettings_EGamePerformanceSetting {
...
function createBaseCMsgKubeRPCPacket(): CMsgKubeRPCPacket {
  return { hdr: undefined, payload: new Uint8Array(0) };
}
...
export const CClanEventData: MessageFns<CClanEventData> = {
  encode(message: CClanEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.rtimeCreated !== undefined && message.rtimeCreated !== 0) {
      writer.uint32(256).uint32(message.rtimeCreated);
    }
    return writer;
  },
...
function createBaseCPackageReservationStatus(): CPackageReservationStatus {
  return {
    ...
    positionIsWaitlist: false,
    userWaitlistToken: "",
    queueInWaitlist: false,
    queueWaitlistToken: "",
...
export const CPackageReservationStatus: MessageFns<CPackageReservationStatus> = {
  encode(message: CPackageReservationStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.positionIsWaitlist !== undefined && message.positionIsWaitlist !== false) {
      writer.uint32(104).bool(message.positionIsWaitlist);
    }
    if (message.userWaitlistToken !== undefined && message.userWaitlistToken !== "") {
      writer.uint32(114).string(message.userWaitlistToken);
    }
    if (message.queueInWaitlist !== undefined && message.queueInWaitlist !== false) {
      writer.uint32(120).bool(message.queueInWaitlist);
    }
    if (message.queueWaitlistToken !== undefined && message.queueWaitlistToken !== "") {
      writer.uint32(130).string(message.queueWaitlistToken);
    }
    if (message.reservationType !== undefined && message.reservationType !== false) {
      writer.uint32(136).bool(message.reservationType);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.positionIsWaitlist = reader.bool();
          continue;
        }
        case 14: {
          if (tag !== 114) {
          ...
          message.userWaitlistToken = reader.string();
          continue;
        }
        case 15: {
          if (tag !== 120) {
          ...
          message.queueInWaitlist = reader.bool();
          continue;
        }
        case 16: {
          if (tag !== 130) {
          ...
          message.queueWaitlistToken = reader.string();
          continue;
        }
        case 17: {
          if (tag !== 136) {
          ...
          message.reservationType = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseUserSystemInformation(): UserSystemInformation {
  return {
    manufacturer: "",
    model: "",
    dxVideoCard: "",
    ...
    screenWidth: 0,
    screenHeight: 0,
    preciseFrameRate: false,
  };
}

export const UserSystemInformation: MessageFns<UserSystemInformation> = {
  encode(message: UserSystemInformation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dxVideoCard !== undefined && message.dxVideoCard !== "") {
      writer.uint32(26).string(message.dxVideoCard);
    }
    if (message.dxVendorid !== undefined && message.dxVendorid !== 0) {
      writer.uint32(32).int32(message.dxVendorid);
    }
    if (message.dxDeviceid !== undefined && message.dxDeviceid !== 0) {
      writer.uint32(40).int32(message.dxDeviceid);
    }
    if (message.numGpu !== undefined && message.numGpu !== 0) {
      writer.uint32(48).uint32(message.numGpu);
    }
    if (message.systemRam !== undefined && message.systemRam !== 0) {
      writer.uint32(56).uint64(message.systemRam);
    }
    if (message.os !== undefined && message.os !== "") {
      writer.uint32(66).string(message.os);
    }
    if (message.cpuVendor !== undefined && message.cpuVendor !== "") {
      writer.uint32(74).string(message.cpuVendor);
    }
    if (message.cpuName !== undefined && message.cpuName !== "") {
      writer.uint32(82).string(message.cpuName);
    }
    if (message.gamingDeviceType !== undefined && message.gamingDeviceType !== 0) {
      writer.uint32(88).uint32(message.gamingDeviceType);
    }
    if (message.dxDriverVersion !== undefined && message.dxDriverVersion !== "") {
      writer.uint32(98).string(message.dxDriverVersion);
    }
    if (message.adapterDescription !== undefined && message.adapterDescription !== "") {
      writer.uint32(114).string(message.adapterDescription);
    }
    if (message.driverVersion !== undefined && message.driverVersion !== "") {
      writer.uint32(122).string(message.driverVersion);
    }
    if (message.driverDate !== undefined && message.driverDate !== "") {
      writer.uint32(130).string(message.driverDate);
    }
    if (message.vramSize !== undefined && message.vramSize !== 0) {
      writer.uint32(136).uint32(message.vramSize);
    }
    if (message.screenWidth !== undefined && message.screenWidth !== 0) {
      writer.uint32(144).uint32(message.screenWidth);
    }
    if (message.screenHeight !== undefined && message.screenHeight !== 0) {
      writer.uint32(152).uint32(message.screenHeight);
    }
    if (message.preciseFrameRate !== undefined && message.preciseFrameRate !== false) {
      writer.uint32(160).bool(message.preciseFrameRate);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UserSystemInformation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUserSystemInformation();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 12: {
          ...
          message.dxDriverVersion = reader.string();
          continue;
        }
        case 14: {
          if (tag !== 114) {
          ...
          message.adapterDescription = reader.string();
          continue;
        }
        case 15: {
          if (tag !== 122) {
        ...
        case 16: {
          ...
          message.driverDate = reader.string();
          continue;
        }
        case 17: {
          if (tag !== 136) {
          ...
          message.vramSize = reader.uint32();
          continue;
        }
        case 18: {
          if (tag !== 144) {
        ...
        case 20: {
          ...
          message.preciseFrameRate = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseGamePerformanceSettings(): GamePerformanceSettings {
  return { setting: 0, gameResolutionWidth: 0, gameResolutionHeight: 0 };
}

export const GamePerformanceSettings: MessageFns<GamePerformanceSettings> = {
  encode(message: GamePerformanceSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.setting !== undefined && message.setting !== 0) {
      writer.uint32(8).int32(message.setting);
    }
    if (message.gameResolutionWidth !== undefined && message.gameResolutionWidth !== 0) {
      writer.uint32(16).uint32(message.gameResolutionWidth);
    }
    if (message.gameResolutionHeight !== undefined && message.gameResolutionHeight !== 0) {
      writer.uint32(24).uint32(message.gameResolutionHeight);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GamePerformanceSettings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGamePerformanceSettings();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.gameResolutionWidth = reader.uint32();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.gameResolutionHeight = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
