...
export interface CMsgClientPICSPrivateBetaResponse {
  ...
  depotSection?: Uint8Array | undefined;
}
...
function createBaseCMsgClientPICSPrivateBetaRequest(): CMsgClientPICSPrivateBetaRequest {
  return { appid: 0, accessToken: 0, betaName: "", passwordHash: new Uint8Array(0) };
}
...
function createBaseCMsgClientPICSPrivateBetaResponse(): CMsgClientPICSPrivateBetaResponse {
  return { eresult: 2, depotSection: new Uint8Array(0) };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.depotSection = reader.bytes();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
