...
export enum ESpeakerConfiguration {
...
export enum EHardwareCompatibilityFeedbackDetails {
...
export enum EGameFrameRateReportingPreference {
...
export enum EContentModerationSanction {
...
export enum EContentReportSubjectAction {
...
export enum EResolutionAutomation {
...
export enum EPressOutletAction {
...
export enum EPressOutletMemberPendingState {
