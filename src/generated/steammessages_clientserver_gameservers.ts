...
function createBaseCMsgGSPlayerList_Player(): CMsgGSPlayerList_Player {
  return { steamId: 0, deprecatedPublicIp: 0, token: new Uint8Array(0), publicIp: undefined };
}
