...
export interface CEconItemDescription {
  ...
  marketBucketGroupName?: string | undefined;
  marketBucketGroupId?: string | undefined;
  sealedType?: number | undefined;
  marketNameInsideGroup?: string | undefined;
}
...
export const CEconItemDescription: MessageFns<CEconItemDescription> = {
  encode(message: CEconItemDescription, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.marketBucketGroupName !== undefined && message.marketBucketGroupName !== "") {
      writer.uint32(274).string(message.marketBucketGroupName);
    }
    if (message.marketBucketGroupId !== undefined && message.marketBucketGroupId !== "") {
      writer.uint32(282).string(message.marketBucketGroupId);
    }
    if (message.sealedType !== undefined && message.sealedType !== 0) {
      writer.uint32(296).uint32(message.sealedType);
    }
    if (message.marketNameInsideGroup !== undefined && message.marketNameInsideGroup !== "") {
      writer.uint32(306).string(message.marketNameInsideGroup);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 34: {
          ...
          message.marketBucketGroupName = reader.string();
          continue;
        }
        case 35: {
          if (tag !== 282) {
          ...
          message.marketBucketGroupId = reader.string();
          continue;
        }
        case 37: {
          if (tag !== 296) {
          ...
          message.sealedType = reader.uint32();
          continue;
        }
        case 38: {
          if (tag !== 306) {
          ...
          message.marketNameInsideGroup = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
