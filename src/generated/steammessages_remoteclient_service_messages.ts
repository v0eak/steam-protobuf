...
export interface CRemoteClientCancelPairingNotification {
  sessionId?: number | undefined;
}
...
export interface CRemoteClientRegisterStatusUpdateNotification {
  ...
  deviceId?: number | undefined;
  disablePolling?: boolean | undefined;
}
...
export interface CRemoteClientOfflineNotification {
  sessionId?: number | undefined;
  steamid?: number | undefined;
  remoteClientId?: number | undefined;
}
...
export interface CRemoteClientEnableSteamBroadcastNotification {
}

export interface CRemoteClientDisableSteamBroadcastNotification {
}
...
export interface CCMRemoteClientServerMessage {
  ...
  offline?: CRemoteClientOfflineNotification | undefined;
}
...
function createBaseCRemoteClientSetPairingInfoRequest(): CRemoteClientSetPairingInfoRequest {
  return { sessionId: 0, deviceId: 0, request: new Uint8Array(0) };
}
...
function createBaseCRemoteClientCancelPairingNotification(): CRemoteClientCancelPairingNotification {
  return { sessionId: 0 };
}

export const CRemoteClientCancelPairingNotification: MessageFns<CRemoteClientCancelPairingNotification> = {
  encode(message: CRemoteClientCancelPairingNotification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== undefined && message.sessionId !== 0) {
      writer.uint32(9).fixed64(message.sessionId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CRemoteClientCancelPairingNotification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCRemoteClientCancelPairingNotification();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
function createBaseCRemoteClientRegisterStatusUpdateNotification(): CRemoteClientRegisterStatusUpdateNotification {
  return { sessionId: 0, steamid: 0, deviceId: 0, disablePolling: false };
}
...
export const CRemoteClientRegisterStatusUpdateNotification: MessageFns<CRemoteClientRegisterStatusUpdateNotification> =
  {
    encode(
      ...
      if (message.disablePolling !== undefined && message.disablePolling !== false) {
        writer.uint32(32).bool(message.disablePolling);
      }
      return writer;
    },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 4: {
            ...
            message.disablePolling = reader.bool();
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCRemoteClientOfflineNotification(): CRemoteClientOfflineNotification {
  return { sessionId: 0, steamid: 0, remoteClientId: 0 };
}

export const CRemoteClientOfflineNotification: MessageFns<CRemoteClientOfflineNotification> = {
  encode(message: CRemoteClientOfflineNotification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== undefined && message.sessionId !== 0) {
      writer.uint32(9).fixed64(message.sessionId);
    }
    if (message.steamid !== undefined && message.steamid !== 0) {
    ...
    if (message.remoteClientId !== undefined && message.remoteClientId !== 0) {
      writer.uint32(25).fixed64(message.remoteClientId);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CRemoteClientOfflineNotification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCRemoteClientOfflineNotification();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
function createBaseCRemoteClientRemotePacketNotification(): CRemoteClientRemotePacketNotification {
  return { sessionId: 0, steamid: 0, payload: new Uint8Array(0) };
}
...
function createBaseCRemoteClientReplyPacketNotification(): CRemoteClientReplyPacketNotification {
  return { sessionId: 0, payload: new Uint8Array(0) };
}
...
function createBaseCRemoteClientEnableSteamBroadcastNotification(): CRemoteClientEnableSteamBroadcastNotification {
  return {};
}

export const CRemoteClientEnableSteamBroadcastNotification: MessageFns<CRemoteClientEnableSteamBroadcastNotification> =
  {
    encode(_: CRemoteClientEnableSteamBroadcastNotification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      return writer;
    },

    decode(input: BinaryReader | Uint8Array, length?: number): CRemoteClientEnableSteamBroadcastNotification {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseCRemoteClientEnableSteamBroadcastNotification();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
        }
...
function createBaseCRemoteClientDisableSteamBroadcastNotification(): CRemoteClientDisableSteamBroadcastNotification {
  return {};
}

export const CRemoteClientDisableSteamBroadcastNotification: MessageFns<
  CRemoteClientDisableSteamBroadcastNotification
> = {
  encode(_: CRemoteClientDisableSteamBroadcastNotification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CRemoteClientDisableSteamBroadcastNotification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCRemoteClientDisableSteamBroadcastNotification();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
...
function createBaseCRemoteClientSteamBroadcastNotification(): CRemoteClientSteamBroadcastNotification {
  return { steamid: 0, clientid: 0, payload: new Uint8Array(0) };
}
...
function createBaseCRemoteClientSteamToSteamNotification(): CRemoteClientSteamToSteamNotification {
  return { steamid: 0, srcClientid: 0, dstClientid: 0, secretid: 0, encryptedPayload: new Uint8Array(0) };
}
...
export const CCMRemoteClientServerMessage: MessageFns<CCMRemoteClientServerMessage> = {
  encode(message: CCMRemoteClientServerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.offline !== undefined) {
      CRemoteClientOfflineNotification.encode(message.offline, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.offline = CRemoteClientOfflineNotification.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
