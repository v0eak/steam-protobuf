...
import { ECommunityItemClass, ENewSteamAnnouncementState, EProfileCustomizationType } from "./enums.js";
import { EBanContentCheckResult, UserContentDescriptorPreferences } from "./steammessages_base.js";
import { NoResponse } from "./steammessages_unified_base.steamclient.js";

export enum EAchievementProgressType {
...
export interface CPlayerGetPlayerLinkDetailsResponse_PlayerLinkDetails_AccountPublicData {
  ...
  shaDigestAvatar?: Uint8Array | undefined;
...
export interface CPlayerGetGameAchievementsResponse {
  ...
  groups: CPlayerGetGameAchievementsResponse_Group[];
...
export interface CPlayerGetGameAchievementsResponse_Achievement {
  ...
  hidden?: boolean | undefined;
  playerPercentUnlocked?: string | undefined;
  internalKey?: number | undefined;
  minProgressInt?: number | undefined;
  maxProgressInt?: number | undefined;
  groupid?: number | undefined;
  archived?: boolean | undefined;
  progressType?: EAchievementProgressType | undefined;
  minProgressFloat?: number | undefined;
  maxProgressFloat?: number | undefined;
}

export interface CPlayerGetGameAchievementsResponse_Group {
  groupid?: number | undefined;
  localizedName?: string | undefined;
  dlcappid?: number | undefined;
  archived?: boolean | undefined;
  developeronly?: boolean | undefined;
  order?: number | undefined;
}

export interface CPlayerGetUserAchievementsRequest {
  steamid?: number | undefined;
  appid?: number | undefined;
}

export interface CPlayerGetUserAchievementsResponse {
  achievements: CPlayerGetUserAchievementsResponse_Achievement[];
  schemaVersion?: number | undefined;
  schemaHash?: number | undefined;
}

export interface CPlayerGetUserAchievementsResponse_Achievement {
  internalKey?: number | undefined;
  unlocked?: boolean | undefined;
  unlockTime?: number | undefined;
  progressInt?: number | undefined;
  progressFloat?: number | undefined;
}

export interface CPlayerGetUserStatsRequest {
  steamid?: number | undefined;
  appid?: number | undefined;
  shaSchema?: Uint8Array | undefined;
  crcStats?: number | undefined;
  crcSchema?: number | undefined;
}

export interface CPlayerGetUserStatsResponse {
  shaSchema?: Uint8Array | undefined;
  crcStats?: number | undefined;
  schema?: Uint8Array | undefined;
  stats: CPlayerGetUserStatsResponse_Stats[];
  crcSchema?: number | undefined;
}

export interface CPlayerGetUserStatsResponse_UnlockTime {
  achievementBit?: number | undefined;
  unlockTime?: number | undefined;
}

export interface CPlayerGetUserStatsResponse_Stats {
  statId?: number | undefined;
  statValue?: number | undefined;
  unlockTimes: CPlayerGetUserStatsResponse_UnlockTime[];
}
...
function createBaseCPlayerGetPlayerLinkDetailsResponse_PlayerLinkDetails_AccountPublicData(): CPlayerGetPlayerLinkDetailsResponse_PlayerLinkDetails_AccountPublicData {
  return {
    ...
    banExpiresTime: 0,
    accountFlags: 0,
    shaDigestAvatar: new Uint8Array(0),
    personaName: "",
    profileUrl: "",
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.shaDigestAvatar = reader.bytes();
          continue;
        }
        case 10: {
          if (tag !== 82) {
...
function createBaseCPlayerGetGameAchievementsRequest(): CPlayerGetGameAchievementsRequest {
  return { appid: 0, language: "", hashOnly: false };
}
...
export const CPlayerGetGameAchievementsRequest: MessageFns<CPlayerGetGameAchievementsRequest> = {
  encode(message: CPlayerGetGameAchievementsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hashOnly !== undefined && message.hashOnly !== false) {
      writer.uint32(24).bool(message.hashOnly);
    }
    return writer;
  },
...
function createBaseCPlayerGetGameAchievementsResponse(): CPlayerGetGameAchievementsResponse {
  return { achievements: [], schemaVersion: 0, groups: [], schemaHash: 0 };
}
...
export const CPlayerGetGameAchievementsResponse: MessageFns<CPlayerGetGameAchievementsResponse> = {
  encode(message: CPlayerGetGameAchievementsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.schemaVersion !== undefined && message.schemaVersion !== 0) {
      writer.uint32(16).int32(message.schemaVersion);
    }
    for (const v of message.groups) {
      CPlayerGetGameAchievementsResponse_Group.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.schemaHash !== undefined && message.schemaHash !== 0) {
      writer.uint32(32).uint32(message.schemaHash);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.groups.push(CPlayerGetGameAchievementsResponse_Group.decode(reader, reader.uint32()));
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.schemaHash = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
> = {
  encode(
    ...
    if (message.internalKey !== undefined && message.internalKey !== 0) {
      writer.uint32(64).uint32(message.internalKey);
    }
    if (message.minProgressInt !== undefined && message.minProgressInt !== 0) {
      writer.uint32(72).int32(message.minProgressInt);
    }
    if (message.maxProgressInt !== undefined && message.maxProgressInt !== 0) {
      writer.uint32(80).int32(message.maxProgressInt);
    }
    if (message.groupid !== undefined && message.groupid !== 0) {
      writer.uint32(88).uint32(message.groupid);
    }
    if (message.archived !== undefined && message.archived !== false) {
      writer.uint32(96).bool(message.archived);
    }
    if (message.progressType !== undefined && message.progressType !== 0) {
      writer.uint32(104).int32(message.progressType);
    }
    if (message.minProgressFloat !== undefined && message.minProgressFloat !== 0) {
      writer.uint32(117).float(message.minProgressFloat);
    }
    if (message.maxProgressFloat !== undefined && message.maxProgressFloat !== 0) {
      writer.uint32(125).float(message.maxProgressFloat);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.internalKey = reader.uint32();
          continue;
        }
        case 9: {
          if (tag !== 72) {
          ...
          message.minProgressInt = reader.int32();
          continue;
        }
        case 10: {
          if (tag !== 80) {
          ...
          message.maxProgressInt = reader.int32();
          continue;
        }
        case 11: {
          if (tag !== 88) {
        ...
        case 13: {
          ...
          message.progressType = reader.int32() as any;
          continue;
        }
        case 14: {
          if (tag !== 117) {
          ...
          message.minProgressFloat = reader.float();
          continue;
        }
        case 15: {
          if (tag !== 125) {
          ...
          message.maxProgressFloat = reader.float();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCPlayerGetGameAchievementsResponse_Group(): CPlayerGetGameAchievementsResponse_Group {
  return { groupid: 0, localizedName: "", dlcappid: 0, archived: false, developeronly: false, order: 0 };
}

export const CPlayerGetGameAchievementsResponse_Group: MessageFns<CPlayerGetGameAchievementsResponse_Group> = {
  encode(message: CPlayerGetGameAchievementsResponse_Group, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.groupid !== undefined && message.groupid !== 0) {
    ...
    if (message.dlcappid !== undefined && message.dlcappid !== 0) {
      writer.uint32(24).uint32(message.dlcappid);
    }
    if (message.archived !== undefined && message.archived !== false) {
      writer.uint32(32).bool(message.archived);
    }
    if (message.developeronly !== undefined && message.developeronly !== false) {
      writer.uint32(40).bool(message.developeronly);
    }
    if (message.order !== undefined && message.order !== 0) {
      writer.uint32(48).uint32(message.order);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetGameAchievementsResponse_Group {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetGameAchievementsResponse_Group();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 5: {
          ...
          message.developeronly = reader.bool();
          continue;
        }
        case 6: {
          if (tag !== 48) {
...
function createBaseCPlayerGetUserAchievementsRequest(): CPlayerGetUserAchievementsRequest {
  return { steamid: 0, appid: 0 };
}

export const CPlayerGetUserAchievementsRequest: MessageFns<CPlayerGetUserAchievementsRequest> = {
  encode(message: CPlayerGetUserAchievementsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.steamid !== undefined && message.steamid !== 0) {
      writer.uint32(8).uint64(message.steamid);
    }
    if (message.appid !== undefined && message.appid !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserAchievementsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserAchievementsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
function createBaseCPlayerGetUserAchievementsResponse(): CPlayerGetUserAchievementsResponse {
  return { achievements: [], schemaVersion: 0, schemaHash: 0 };
}

export const CPlayerGetUserAchievementsResponse: MessageFns<CPlayerGetUserAchievementsResponse> = {
  encode(message: CPlayerGetUserAchievementsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.achievements) {
      CPlayerGetUserAchievementsResponse_Achievement.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.schemaVersion !== undefined && message.schemaVersion !== 0) {
      writer.uint32(16).int32(message.schemaVersion);
    }
    if (message.schemaHash !== undefined && message.schemaHash !== 0) {
      writer.uint32(24).uint32(message.schemaHash);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserAchievementsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserAchievementsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.achievements.push(CPlayerGetUserAchievementsResponse_Achievement.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 16) {
...
function createBaseCPlayerGetUserAchievementsResponse_Achievement(): CPlayerGetUserAchievementsResponse_Achievement {
  return { internalKey: 0, unlocked: false, unlockTime: 0, progressInt: 0, progressFloat: 0 };
}

export const CPlayerGetUserAchievementsResponse_Achievement: MessageFns<
  CPlayerGetUserAchievementsResponse_Achievement
> = {
  encode(
    message: CPlayerGetUserAchievementsResponse_Achievement,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.internalKey !== undefined && message.internalKey !== 0) {
      writer.uint32(8).uint32(message.internalKey);
    }
    if (message.unlocked !== undefined && message.unlocked !== false) {
      writer.uint32(16).bool(message.unlocked);
    }
    if (message.unlockTime !== undefined && message.unlockTime !== 0) {
      writer.uint32(29).fixed32(message.unlockTime);
    }
    if (message.progressInt !== undefined && message.progressInt !== 0) {
      writer.uint32(32).int32(message.progressInt);
    }
    if (message.progressFloat !== undefined && message.progressFloat !== 0) {
      writer.uint32(45).float(message.progressFloat);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserAchievementsResponse_Achievement {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserAchievementsResponse_Achievement();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 4: {
          ...
          message.progressInt = reader.int32();
          continue;
        }
        case 5: {
          if (tag !== 45) {
          ...
          message.progressFloat = reader.float();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCPlayerGetUserStatsRequest(): CPlayerGetUserStatsRequest {
  return { steamid: 0, appid: 0, shaSchema: new Uint8Array(0), crcStats: 0, crcSchema: 0 };
}

export const CPlayerGetUserStatsRequest: MessageFns<CPlayerGetUserStatsRequest> = {
  encode(message: CPlayerGetUserStatsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.steamid !== undefined && message.steamid !== 0) {
      writer.uint32(8).uint64(message.steamid);
    }
    if (message.appid !== undefined && message.appid !== 0) {
    ...
    if (message.shaSchema !== undefined && message.shaSchema.length !== 0) {
      writer.uint32(26).bytes(message.shaSchema);
    }
    if (message.crcStats !== undefined && message.crcStats !== 0) {
      writer.uint32(32).uint32(message.crcStats);
    }
    if (message.crcSchema !== undefined && message.crcSchema !== 0) {
      writer.uint32(40).uint32(message.crcSchema);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserStatsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserStatsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.shaSchema = reader.bytes();
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 5: {
          ...
          message.crcSchema = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCPlayerGetUserStatsResponse(): CPlayerGetUserStatsResponse {
  return { shaSchema: new Uint8Array(0), crcStats: 0, schema: new Uint8Array(0), stats: [], crcSchema: 0 };
}

export const CPlayerGetUserStatsResponse: MessageFns<CPlayerGetUserStatsResponse> = {
  encode(message: CPlayerGetUserStatsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.shaSchema !== undefined && message.shaSchema.length !== 0) {
      writer.uint32(10).bytes(message.shaSchema);
    }
    if (message.crcStats !== undefined && message.crcStats !== 0) {
    ...
    for (const v of message.stats) {
      CPlayerGetUserStatsResponse_Stats.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.crcSchema !== undefined && message.crcSchema !== 0) {
      writer.uint32(40).uint32(message.crcSchema);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserStatsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserStatsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 4: {
          ...
          message.stats.push(CPlayerGetUserStatsResponse_Stats.decode(reader, reader.uint32()));
          continue;
        }
        case 5: {
          if (tag !== 40) {
...
function createBaseCPlayerGetUserStatsResponse_UnlockTime(): CPlayerGetUserStatsResponse_UnlockTime {
  return { achievementBit: 0, unlockTime: 0 };
}

export const CPlayerGetUserStatsResponse_UnlockTime: MessageFns<CPlayerGetUserStatsResponse_UnlockTime> = {
  encode(message: CPlayerGetUserStatsResponse_UnlockTime, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.achievementBit !== undefined && message.achievementBit !== 0) {
      writer.uint32(8).uint32(message.achievementBit);
    }
    if (message.unlockTime !== undefined && message.unlockTime !== 0) {
      writer.uint32(21).fixed32(message.unlockTime);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserStatsResponse_UnlockTime {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserStatsResponse_UnlockTime();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.achievementBit = reader.uint32();
          continue;
        }
        case 2: {
          if (tag !== 21) {
...
function createBaseCPlayerGetUserStatsResponse_Stats(): CPlayerGetUserStatsResponse_Stats {
  return { statId: 0, statValue: 0, unlockTimes: [] };
}

export const CPlayerGetUserStatsResponse_Stats: MessageFns<CPlayerGetUserStatsResponse_Stats> = {
  encode(message: CPlayerGetUserStatsResponse_Stats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.statId !== undefined && message.statId !== 0) {
      writer.uint32(8).uint32(message.statId);
    }
    ...
    for (const v of message.unlockTimes) {
      CPlayerGetUserStatsResponse_UnlockTime.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CPlayerGetUserStatsResponse_Stats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCPlayerGetUserStatsResponse_Stats();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.unlockTimes.push(CPlayerGetUserStatsResponse_UnlockTime.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export interface Player {
  ...
  GetUserAchievements(request: CPlayerGetUserAchievementsRequest): Promise<CPlayerGetUserAchievementsResponse>;
  GetUserStats(request: CPlayerGetUserStatsRequest): Promise<CPlayerGetUserStatsResponse>;
