...
export interface ContentDeltaChunks_DeltaChunk {
  shaSource?: Uint8Array | undefined;
  shaTarget?: Uint8Array | undefined;
...
function createBaseContentManifestPayload_FileMapping(): ContentManifestPayload_FileMapping {
  return {
    ...
    size: 0,
    flags: 0,
    shaFilename: new Uint8Array(0),
    shaContent: new Uint8Array(0),
    chunks: [],
    linktarget: "",
  };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.shaFilename = reader.bytes();
          continue;
        }
        case 5: {
          if (tag !== 42) {
          ...
          message.shaContent = reader.bytes();
          continue;
        }
        case 6: {
          if (tag !== 50) {
...
function createBaseContentManifestPayload_FileMapping_ChunkData(): ContentManifestPayload_FileMapping_ChunkData {
  return { sha: new Uint8Array(0), crc: 0, offset: 0, cbOriginal: 0, cbCompressed: 0 };
}
...
function createBaseContentDeltaChunks_DeltaChunk(): ContentDeltaChunks_DeltaChunk {
  return {
    shaSource: new Uint8Array(0),
    shaTarget: new Uint8Array(0),
    sizeOriginal: 0,
    patchMethod: 0,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.shaSource = reader.bytes();
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.shaTarget = reader.bytes();
          continue;
        }
        case 3: {
          if (tag !== 24) {
