...
export interface CShaderRegisterShaderRequest_Shader {
  cacheKeySha?: Uint8Array | undefined;
  shaderCodeSha?: Uint8Array | undefined;
}
...
export interface CShaderSendShaderRequest_ShaderCode {
  shaderCodeSha?: Uint8Array | undefined;
  shaderCode?: Uint8Array | undefined;
}
...
export interface CShaderReportBucketProcessingCompleteRequest {
  appid?: number | undefined;
  gpuDesc?: string | undefined;
  driverDesc?: string | undefined;
}

export interface CShaderReportBucketProcessingCompleteResponse {
}
...
function createBaseCShaderRegisterShaderRequest_Shader(): CShaderRegisterShaderRequest_Shader {
  return { cacheKeySha: new Uint8Array(0), shaderCodeSha: new Uint8Array(0) };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.cacheKeySha = reader.bytes();
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.shaderCodeSha = reader.bytes();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCShaderSendShaderRequest_ShaderCode(): CShaderSendShaderRequest_ShaderCode {
  return { shaderCodeSha: new Uint8Array(0), shaderCode: new Uint8Array(0) };
}
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.shaderCode = reader.bytes();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseCShaderGetStaleBucketResponse(): CShaderGetStaleBucketResponse {
  return { bucketid: 0, appid: 0, manifestid: 0, gpuDesc: "", driverDesc: "", depotEncryptionKey: new Uint8Array(0) };
}
...
function createBaseCShaderReportBucketProcessingCompleteRequest(): CShaderReportBucketProcessingCompleteRequest {
  return { appid: 0, gpuDesc: "", driverDesc: "" };
}

export const CShaderReportBucketProcessingCompleteRequest: MessageFns<CShaderReportBucketProcessingCompleteRequest> = {
  encode(
    message: CShaderReportBucketProcessingCompleteRequest,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CShaderReportBucketProcessingCompleteRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCShaderReportBucketProcessingCompleteRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
...
function createBaseCShaderReportBucketProcessingCompleteResponse(): CShaderReportBucketProcessingCompleteResponse {
  return {};
}

export const CShaderReportBucketProcessingCompleteResponse: MessageFns<CShaderReportBucketProcessingCompleteResponse> =
  {
    encode(_: CShaderReportBucketProcessingCompleteResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      return writer;
    },

    decode(input: BinaryReader | Uint8Array, length?: number): CShaderReportBucketProcessingCompleteResponse {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      const end = length === undefined ? reader.len : reader.pos + length;
      const message = createBaseCShaderReportBucketProcessingCompleteResponse();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
        }
...
export interface Shader {
  ...
  ReportBucketProcessingComplete(
    request: CShaderReportBucketProcessingCompleteRequest,
  ): Promise<CShaderReportBucketProcessingCompleteResponse>;
}
